  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 md:p-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center gap-5 mb-6">
        <Avatar className="w-24 h-24 md:w-28 md:h-28 rounded-full border-4 border-black">
          <AvatarImage 
        ...
        <div>
          <div className="flex flex-wrap items-center gap-2">
            <h1 className="text-2xl md:text-3xl font-bold text-[#0a2463] flex items-center">
              Future Remodeling
      ...
      {/* CTA section - now in its own separate container */}
      <div className="border-t pt-5 mt-2">
        <h3 className="text-lg font-medium text-gray-700 mb-3">Contact Us Today</h3>
